...
class KazagumoTrack {
    constructor(raw, requester) {
        ...
        this.realUri = Interfaces_1.SupportedSources.includes(this.sourceName) ? this.uri : null;
    ...
    getTrack(player) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.author) {
                ...
                const officialTrack = result.tracks.find((track) => author.some((name) => new RegExp(`^${(0, Interfaces_1.escapeRegExp)(name)}$`, 'i').test(track.info.author)) ||
